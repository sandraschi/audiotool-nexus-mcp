      ...
      <div className="flex-1 flex flex-col space-y-6">
        ...
        <div className="glass-panel flex-1 relative overflow-hidden flex flex-col p-6 space-y-6">
          <div className="absolute top-0 right-0 p-4 flex gap-2">
            <div className="px-3 py-1 rounded bg-amber-500 text-zinc-950 text-[10px] font-bold uppercase tracking-widest">
              Live Buffer
            </div>
            <div className="px-3 py-1 rounded bg-zinc-900 border border-zinc-800 text-zinc-500 text-[10px] font-bold uppercase tracking-widest">
              48kHz / 24bit
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <button className="w-12 h-12 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white transition-all">
                <Rewind size={20} />
              </button>
              <button className="w-16 h-16 rounded-2xl bg-amber-500 shadow-[0_0_30px_rgba(245,158,11,0.2)] flex items-center justify-center text-zinc-950 hover:bg-amber-400 transition-all">
            ...
            <div className="flex gap-4">
              <div className="text-right">
                <span className="text-[10px] text-zinc-600 block uppercase font-bold mb-1">
                  Pitch Shift
                </span>
        ...
        <div className="bg-zinc-900 border border-zinc-800/50 rounded-2xl p-6 space-y-6 h-full flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto space-y-2 scrollbar-none">
            {[
              ...
              <div
                key={i}
                className="group p-3 rounded-xl border border-transparent hover:border-white/5 hover:bg-white/[0.02] transition-all flex items-center justify-between cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  <Waves
                    size={14}
                    className="text-zinc-700 group-hover:text-amber-500/50 transition-colors"
                  />
                  <div>
                    <p className="text-[12px] font-medium text-zinc-400 group-hover:text-zinc-100 transition-colors truncate w-32">
                      {sample.name}
                    </p>
                ...
                <MoreVertical
                  size={14}
                  className="text-zinc-800 opacity-0 group-hover:opacity-100 transition-opacity"
                />
              </div>
            ))}
          </div>
