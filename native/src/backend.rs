...
const BACKEND_NAME: &str = "audiotool-nexus-mcp-backend.exe";
const BACKEND_PORT: u16 = 11172;
const BACKEND_TAG: &str = "audiotool-nexus-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "AUDIOTOOL_NEXUS_MCP_PORT";
const ENV_HOST: &str = "AUDIOTOOL_NEXUS_MCP_HOST";
const ENV_TAURI: &str = "AUDIOTOOL_NEXUS_MCP_TAURI";
