...
4. Start the server:
   ...
   uv run python -m audiotool_nexus_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn audiotool_nexus_mcp.server:app --port 10900
   ```
...
5. Open `http://localhost:10900` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/audiotool-nexus-mcp/issues) |
